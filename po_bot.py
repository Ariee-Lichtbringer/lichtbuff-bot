            ...
            try:
                result = await self.api.get(
                    ...
                    types=(
                        ...
                        "p0plus_points_notice,p0plus_resolution_notice,player_login_approval_notice,po_approval_notice,po_rejection_notice,po_release_granted_notice,po_release_received_notice,armor_request_notice,po_release_request_notice,raid_calendar,raid_signup_notice,raid_status_staff_notice"
                    ),
                    limit="20",
                    claimMode="manual-v1",
                )
